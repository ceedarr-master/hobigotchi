...
export const ITEMS = [
    ...
    // --- FOOD: MEAL (식사) ---
    {
      ...
      r: 10, g: -5, b: 2, y: 10, hp: 20, clean: -20, love: 5, unlock: 3
    },
     {
      id: 'f_chicken', type: 'food', group: 'meal', icon: `${ICON_BASE}/food.svg`,
      ko: '후라이드치킨', en: 'Fried chicken', jp: 'チキン',
      r: 10, g: -5, b: 2, y: 10, hp: 30, clean: -20, love: 15, unlock: 1
    },
    {
      id: 'f_pho', type: 'food', group: 'meal', icon: `${ICON_BASE}/food.svg`,
      ko: '쌀국수', en: 'Pho', jp: 'フォー',
      r: 10, g: -5, b: 2, y: 10, hp: 30, clean: -10, love: 0, unlock: 2
    },
    {
    ...
    // --- BASIC ACTIONS (기본) ---
    {
      ...
      ko: '씻기', en: 'wash', jp: '洗う',
      r: 0, g: 2, b: 10, y: 0, hp: -15, clean: 50, love: 10, unlock: 1
    },
    {
      id: 'basic_sleep', type: 'basic', group: 'basic', icon: `${ICON_BASE}/moon.svg`,
      ko: '재우기', en: 'rest', jp: '寝る',
      r: 0, g: 0, b: -10, y: 0, hp: 60, clean: -10, love: -10, unlock: 1
    }
];